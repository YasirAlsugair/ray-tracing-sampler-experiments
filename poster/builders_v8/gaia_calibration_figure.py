#!/usr/bin/env python3
"""Create the Gaia calibration panel from the locked vector PDF.
...
SOURCE = POSTER / "artifacts" / "figures"
OUT = POSTER / "artifacts" / "figures_v8"
...
ENSEMBLE_50 = POSTER / "artifacts" / "gaia_v6" / "exp7_ensemble_50.npz"
...
def convert(name: str, *, rename_rt: bool = False) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="suds-v6-gaia-") as temp:
        ...
        _run("pdftops", "-level3", str(SOURCE / f"{name}.pdf"), str(source_ps))
