...
\begin{itemize}\setlength{\itemsep}{0.02cm}
  ...
  \item We took the ray tracing sampler from its paper\refmark{2} to a
    ...
    guessing.
  \item The gains held on real data: averaged over the 25{,}232 held-out
    stars, predictions were 27\% more probable under the posterior
    average than under the single best fit; 23\% of that comes from the
    averaging alone, the rest from the chain's heavier-tailed likelihood.
\end{itemize}
\end{block}
