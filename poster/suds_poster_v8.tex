...
\begin{itemize}\setlength{\itemsep}{0.02cm}
  ...
  \item The gains held on real data: held-out stars were 27\% more
    probable under the posterior average than under the single fit, and
    per effective sample, minibatching touched 3.3\(\times\) fewer data
    rows than the same sampler run full batch (superconductivity
    benchmark).
\end{itemize}
\end{block}
