...
\begin{itemize}\setlength{\itemsep}{0.02cm}
  \item We took the sampler from its paper to a real survey posterior.
    The draws are the product: averaging them beat the single best fit,
    and their spread warns us when the model is guessing.
