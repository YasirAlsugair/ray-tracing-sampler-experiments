...
\begin{itemize}\setlength{\itemsep}{0.02cm}
  ...
  \item On real data the clean scaling breaks down, but the sampler still
    works, and an effective sample costs less than with minibatch HMC.
  \item On the Gaia data, averaging the draws gave better predictions than
    the single fit, and the error bars were correct in every group. A
    large spread for a star means do not trust that prediction.
\end{itemize}
\end{block}
