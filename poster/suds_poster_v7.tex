...
\begin{itemize}\setlength{\itemsep}{0.02cm}
  ...
  \item Real data is messier than the theory, but the advantage survives
    ...
    alternatives.
  \item Out-of-distribution data is the risky case: a single fit still
    answers with full confidence. The posterior draws spread out there,
    and that tells us the model is guessing.
\end{itemize}
\end{block}
