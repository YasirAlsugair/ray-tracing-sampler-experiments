...
\begin{itemize}\setlength{\itemsep}{0.02cm}
  ...
  \item Real data is messier than the theory, but the advantage survives
    ...
    alternatives.
  \item The payoff is marginalization: average the prediction over the
    posterior draws instead of trusting one fitted network. The average is
    more accurate, and the spread warns us when the model is guessing.
\end{itemize}
\end{block}
