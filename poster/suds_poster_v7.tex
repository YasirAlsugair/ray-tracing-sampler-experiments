...
\begin{itemize}\setlength{\itemsep}{0.02cm}
  ...
  \item Real data is messier than the theory, but the advantage survives
    ...
    alternatives.
  \item The framework is general: sample any network's posterior and every
    prediction comes with error bars. For inputs far from the training
    data the draws spread out, which helps to catch out-of-distribution
    cases.
\end{itemize}
\end{block}
